                ...
                <div>
                  ...
                  {uploadedImage ? (
                    <div className="relative overflow-hidden rounded-[7px] border border-[#d6dde2] bg-white p-[8px]">
                      ...
                      <div className="mt-[8px] flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="rounded-[4px] border border-[#dfe4e8] bg-white px-[10px] py-[4px] text-[8.5px] font-bold text-[#35445f] hover:bg-slate-50"
                        >
                          Change Image
                        </button>
                      </div>
                    ...
                    >
                      ...
                      <p className="mt-[9px] text-[10.5px] font-bold text-[#49566e]">
                        Drag &amp; drop image here or
                      </p>
                      <span className="mt-[8px] inline-flex h-[32px] items-center gap-[7px] rounded-[5px] border border-[#cfe0d4] bg-white px-[12px] text-[8.8px] font-bold text-[#14683d]">
              ...
              <div className="rounded-[7px] border border-[#e4e8eb] bg-white px-[18px] py-[14px]">
                <div className="flex items-start gap-[10px]">
                  ...
                  <div className="min-w-0">
                    <p className="text-[9px] font-bold text-[#35445f]">mokshasewa.org</p>
                ...
                <p className="mt-[10px] text-[14px] font-extrabold text-[#233b8c]">
              ...
              <div className="space-y-[14px]">
                ...
                <div className="space-y-[12px]">
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className="text-[10.5px] font-extrabold text-[#24345e]">Publish Immediately</p>
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className="text-[10.5px] font-extrabold text-[#24345e]">Schedule for Later</p>
                      <p className="mt-[3px] text-[9px] font-semibold text-[#6d7890]">
                ...
                <div className="flex min-h-[38px] items-center gap-[9px] rounded-[6px] border border-[#d9e7f5] bg-[linear-gradient(90deg,#f2f8ff,#f7fbff)] px-[12px]">
                  ...
                  <p className="text-[8.8px] font-semibold text-[#52627b]">
                    <strong className="text-[#32435f]">Tip:</strong> Publish at the right time to reach more people.
                  </p>
                </div>
              </div>
            </Panel>
            ...
            <Panel title="3. Additional Settings">
              <div className="space-y-[12px]">
                <div className="flex items-center justify-between gap-[14px]">
                  <div>
                    <p className="text-[10.5px] font-extrabold text-[#24345e]">Allow Comments</p>
                    <p className="mt-[3px] text-[9px] font-semibold text-[#6d7890]">
                ...
                <div className="flex items-center justify-between gap-[14px]">
                  <div>
                    <p className="text-[10.5px] font-extrabold text-[#24345e]">Show in Homepage</p>
                    <p className="mt-[3px] text-[9px] font-semibold text-[#6d7890]">
                ...
                <div className="flex items-center justify-between gap-[14px]">
                  <div>
                    <p className="text-[10.5px] font-extrabold text-[#24345e]">
