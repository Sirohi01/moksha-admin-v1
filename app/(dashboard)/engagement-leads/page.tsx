  ...
  return (
    ...
    >
        ...
        >
          ...
          <DashboardCard>
            ...
            >
              <h2 className={sectionHeading}>
                Engagement Trend
                <span className="ml-[4px] text-[8px] font-[600] text-[#6B748B]">
                  (Last 7 Days)
                </span>
              </h2>
              ...
              {followUps.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p className="text-[7px] font-[500] text-[#7A8397]">
                        Assigned to
                      </p>
      ...
      <div
        ...
        "
      >
        <h2 className="text-[10px] font-[800] text-[#17613B]">
          Quick Actions
        </h2>
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full items-center justify-start gap-[4px] whitespace-nowrap text-left">
        ...
        <span className="text-[8.5px] font-[500] text-[#596685]">
          vs last 7 days
        </span>
      </div>
    </div>
...
function FunnelRow({
  ...
  return (
    ...
    >
      ...
      <span className="text-right text-[8px] font-[800] text-[#26376B]">
        {value}
      </span>

      <span className="text-right text-[7px] font-[600] text-[#5C6883]">
        {extra ?? ""}
      </span>
    </div>
  );
      ...
      {[0, 100, 200, 300, 400, 500].map((value) => {
        ...
        return (
          <g key={value}>
            ...
            <text x="0" y={y + 3} fontSize="8" fill="#667085">
              {value}
            </text>
          </g>
        );
...
function TableHead({ children }: { children: ReactNode }) {
  return (
    <th className="px-[8px] text-[7.5px] font-[700] text-[#182A65]">
      {children}
    </th>
  );
}
