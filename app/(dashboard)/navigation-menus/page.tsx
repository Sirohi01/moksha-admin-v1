                  ...
                  <tbody>
                    {rows.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-[8px]">
                          <span
                            className={`inline-flex rounded-[4px] border px-[8px] py-[2.5px] text-[8px] font-semibold ${
                              item.status === "Active"
                        ...
                        <td className="px-[8px]">
                          <p className="text-[8.5px] font-semibold text-[#34425e]">
                            {item.updatedDate}
                          </p>
            ...
            <div className="mt-[10px] flex items-end gap-[8px] border-b border-[#e7eaed]">
              {(["Menu Structure", "Menu Settings"] as const).map((tab) => (
                <button
                  ...
                  className={`relative h-[30px] px-[10px] text-[9px] font-semibold ${
