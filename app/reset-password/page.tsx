    ...
    <div className="relative min-h-screen bg-slate-50">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="text-center text-3xl font-extrabold tracking-tight text-slate-900">Reset Password</h2>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/50 bg-white/20 px-4 py-8 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-2xl sm:px-10">
          ...
          {!token ? (
            <div className="text-center">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Invalid Link</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Password Reset</h3>
              <p className="mt-2 text-sm text-slate-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="text-center">
                ...
                <h3 className="mt-5 text-xl font-bold text-slate-900">Set a new password</h3>
